...
- Also observed, not changed here: `track_set_properties` (`SetTrack`) and `track_mute` (`SetTrackStatus`) apply to every *selected* track, not only the index given — renaming track 1 while tracks 0 and 1 were selected renamed both.
